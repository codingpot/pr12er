...
class MappingTable extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<MappingTableRow>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'rows',
        $pb.PbFieldType.PM,
        subBuilder: MappingTableRow.create)
  ...
  factory MappingTable.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory MappingTable.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  MappingTable copyWith(void Function(MappingTable) updates) =>
      super.copyWith((message) => updates(message as MappingTable))
          as MappingTable; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static MappingTable create() => MappingTable._();
  MappingTable createEmptyInstance() => create();
  static $pb.PbList<MappingTable> createRepeated() =>
      $pb.PbList<MappingTable>();
  @$core.pragma('dart2js:noInline')
  static MappingTable getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<MappingTable>(create);
...
class MappingTableRow extends $pb.GeneratedMessage {
  ...
  factory MappingTableRow.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory MappingTableRow.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  MappingTableRow copyWith(void Function(MappingTableRow) updates) =>
      super.copyWith((message) => updates(message as MappingTableRow))
          as MappingTableRow; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static MappingTableRow create() => MappingTableRow._();
  MappingTableRow createEmptyInstance() => create();
  static $pb.PbList<MappingTableRow> createRepeated() =>
      $pb.PbList<MappingTableRow>();
  @$core.pragma('dart2js:noInline')
  static MappingTableRow getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<MappingTableRow>(create);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..m<$core.int, PrVideo>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'prIdToVideo',
        entryClassName: 'Database.PrIdToVideoEntry',
        keyFieldType: $pb.PbFieldType.O3,
        valueFieldType: $pb.PbFieldType.OM,
        valueCreator: PrVideo.create,
        packageName: const $pb.PackageName('pkg.pr12er'))
    ..hasRequiredFields = false;
...
class PrVideo extends $pb.GeneratedMessage {
  ...
  factory PrVideo.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PrVideo.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  PrVideo copyWith(void Function(PrVideo) updates) =>
      super.copyWith((message) => updates(message as PrVideo))
          as PrVideo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static PrVideo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PrVideo>(create);
...
class YouTubeVideo extends $pb.GeneratedMessage {
  ...
  factory YouTubeVideo.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory YouTubeVideo.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  YouTubeVideo copyWith(void Function(YouTubeVideo) updates) =>
      super.copyWith((message) => updates(message as YouTubeVideo))
          as YouTubeVideo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static YouTubeVideo create() => YouTubeVideo._();
  YouTubeVideo createEmptyInstance() => create();
  static $pb.PbList<YouTubeVideo> createRepeated() =>
      $pb.PbList<YouTubeVideo>();
  @$core.pragma('dart2js:noInline')
  static YouTubeVideo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<YouTubeVideo>(create);
  ...
  @$pb.TagNumber(3)
  set numberOfLikes($fixnum.Int64 v) {
    $_setInt64(2, v);
  }
  ...
  @$pb.TagNumber(4)
  set numberOfViews($fixnum.Int64 v) {
    $_setInt64(3, v);
  }
  ...
  @$pb.TagNumber(5)
  set publishedDate($1.Timestamp v) {
    setField(5, v);
  }
